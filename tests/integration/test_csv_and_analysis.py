...
def test_aggregate_year_summary_sums_all_tickers(tx_factory):
    ...
    assert summaries[2025].total_costs == Decimal("40")
    assert summaries[2025].total_costs_czk == Decimal("860")
    assert summaries[2025].total_pl == Decimal("30")
    assert summaries[2025].total_pl_czk == Decimal("890")
    assert summaries[2025].pass_income == Decimal("50")
    assert summaries[2025].pass_income_czk == Decimal("1250")
    assert summaries[2025].pass_costs == Decimal("10")
    assert summaries[2025].pass_costs_czk == Decimal("200")
    assert summaries[2025].taxable_pl == Decimal("-10")
    assert summaries[2025].taxable_pl_czk == Decimal("-160")
    assert summaries[2025].fail_income == Decimal("20")
    assert summaries[2025].fail_income_czk == Decimal("500")
    assert summaries[2025].fail_costs == Decimal("30")
    assert summaries[2025].fail_costs_czk == Decimal("660")
